...
class PatternImportTemplateExport implements FromArray, WithHeadings
{
    public function headings(): array
    {
        ...
        return ['Machine', 'Urutan', 'Item', 'Jumlah Proses', 'Proses', 'loading_time', 'dandori', 'Shift', 'lot'];
    }

    public function array(): array
    {
        return [
            ['PT91', 1, 'GA241-04750', 9, 2, 40, 10, 1, 100],
            ['PT92', 1, 'GA241-04750', 9, 3, 40, 10, 1, 100],
            ['PT91', 2, '57453-BZ140', 8, 2, 160, 10, 2, 50],
        ];
    }
}
