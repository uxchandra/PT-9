                ...
                <nav class="px-3 mt-3 space-y-0.5 overflow-y-auto" style="height: calc(100vh - 80px - 88px);">
                    ...
                    <div>
                        ...
                        <div x-show="openMenu === 'andon'" x-cloak class="ml-8 mt-1 space-y-1">
                            ...
                            <a href="{{ route('andon-heijunka-box.show') }}" target="_blank"
                               class="submenu-item flex items-center px-3 py-2.5 text-sm text-gray-300">
                                <svg class="w-4 h-4 mr-2 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 6v12a2 2 0 002 2h12a2 2 0 002-2V6M4 6l2-2h12l2 2M9 10h6M9 14h6"/>
                                </svg>
                                {{ __('Heijunka') }}
                            </a>
                    ...
                    <div>
                        ...
                        <div x-show="openMenu === 'lot-making'" x-cloak class="ml-8 mt-1 space-y-1">
                            ...
                            <a href="{{ route('lot-making-plannings.index') }}"
                               class="submenu-item flex items-center px-3 py-2.5 text-sm text-gray-300 {{ request()->routeIs('lot-making-plannings.*') ? 'active' : '' }}">
                                <svg class="w-4 h-4 mr-2 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
