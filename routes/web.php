...
use App\Http\Controllers\AndonHeijunkaBoxController;
use App\Http\Controllers\AndonKeseiController;
use App\Http\Controllers\AndonLotMakingController;
use App\Http\Controllers\AndonProductionController;
...
Route::get('/andon-heijunka-box', [AndonHeijunkaBoxController::class, 'show'])->name('andon-heijunka-box.show');
